...
// Validate checks the field values on AllOrdersInfoResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *AllOrdersInfoResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AllOrdersInfoResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AllOrdersInfoResponseMultiError, or nil if none found.
func (m *AllOrdersInfoResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *AllOrdersInfoResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetOrdersInfo() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, AllOrdersInfoResponseValidationError{
						field:  fmt.Sprintf("OrdersInfo[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
			...
			if err := v.Validate(); err != nil {
				return AllOrdersInfoResponseValidationError{
					field:  fmt.Sprintf("OrdersInfo[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return AllOrdersInfoResponseMultiError(errors)
	}

	return nil
}

// AllOrdersInfoResponseMultiError is an error wrapping multiple validation
// errors returned by AllOrdersInfoResponse.ValidateAll() if the designated
// constraints aren't met.
type AllOrdersInfoResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AllOrdersInfoResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AllOrdersInfoResponseMultiError) AllErrors() []error { return m }

// AllOrdersInfoResponseValidationError is the validation error returned by
// AllOrdersInfoResponse.Validate if the designated constraints aren't met.
type AllOrdersInfoResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AllOrdersInfoResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AllOrdersInfoResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AllOrdersInfoResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AllOrdersInfoResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AllOrdersInfoResponseValidationError) ErrorName() string {
	return "AllOrdersInfoResponseValidationError"
}

// Error satisfies the builtin error interface
func (e AllOrdersInfoResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAllOrdersInfoResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AllOrdersInfoResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AllOrdersInfoResponseValidationError{}

// Validate checks the field values on OrderInfoWithID with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *OrderInfoWithID) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on OrderInfoWithID with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// OrderInfoWithIDMultiError, or nil if none found.
func (m *OrderInfoWithID) ValidateAll() error {
	return m.validate(true)
}

func (m *OrderInfoWithID) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, OrderInfoWithIDValidationError{
					field:  "Id",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return OrderInfoWithIDValidationError{
				field:  "Id",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if all {
		switch v := interface{}(m.GetOrdersInfo()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, OrderInfoWithIDValidationError{
					field:  "OrdersInfo",
	...
	} else if v, ok := interface{}(m.GetOrdersInfo()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return OrderInfoWithIDValidationError{
				field:  "OrdersInfo",
				reason: "embedded message failed validation",
	...
	if len(errors) > 0 {
		return OrderInfoWithIDMultiError(errors)
	}

	return nil
}

// OrderInfoWithIDMultiError is an error wrapping multiple validation errors
// returned by OrderInfoWithID.ValidateAll() if the designated constraints
// aren't met.
type OrderInfoWithIDMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m OrderInfoWithIDMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m OrderInfoWithIDMultiError) AllErrors() []error { return m }

// OrderInfoWithIDValidationError is the validation error returned by
// OrderInfoWithID.Validate if the designated constraints aren't met.
type OrderInfoWithIDValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e OrderInfoWithIDValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e OrderInfoWithIDValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e OrderInfoWithIDValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e OrderInfoWithIDValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e OrderInfoWithIDValidationError) ErrorName() string { return "OrderInfoWithIDValidationError" }

// Error satisfies the builtin error interface
func (e OrderInfoWithIDValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sOrderInfoWithID.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = OrderInfoWithIDValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = OrderInfoWithIDValidationError{}
