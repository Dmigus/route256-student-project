...
//go:generate minimock -i route256.ozon.ru/project/loms/internal/usecases/stocksinfogetter.txManager -o tx_manager_mock_test.go -n TxManagerMock -p stocksinfogetter
...
type TxManagerMock struct {
	...
	funcWithinTransaction          func(ctx context.Context, f1 func(ctx context.Context, _ any, stocks StockRepo) error) (err error)
	inspectFuncWithinTransaction   func(ctx context.Context, f1 func(ctx context.Context, _ any, stocks StockRepo) error)
...
type TxManagerMockWithinTransactionParams struct {
	ctx context.Context
	f1  func(ctx context.Context, _ any, stocks StockRepo) error
}
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Expect(ctx context.Context, f1 func(ctx context.Context, _ any, stocks StockRepo) error) *mTxManagerMockWithinTransaction {
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Inspect(f func(ctx context.Context, f1 func(ctx context.Context, _ any, stocks StockRepo) error)) *mTxManagerMockWithinTransaction {
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Set(f func(ctx context.Context, f1 func(ctx context.Context, _ any, stocks StockRepo) error) (err error)) *TxManagerMock {
	if mmWithinTransaction.defaultExpectation != nil {
...
// Then helper
func (mmWithinTransaction *mTxManagerMockWithinTransaction) When(ctx context.Context, f1 func(ctx context.Context, _ any, stocks StockRepo) error) *TxManagerMockWithinTransactionExpectation {
	if mmWithinTransaction.mock.funcWithinTransaction != nil {
		mmWithinTransaction.mock.t.Fatalf("TxManagerMock.WithinTransaction mock is already set by Set")
	}
...
func (mmWithinTransaction *TxManagerMock) WithinTransaction(ctx context.Context, f1 func(ctx context.Context, _ any, stocks StockRepo) error) (err error) {
