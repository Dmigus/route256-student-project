...
//go:generate minimock -i route256.ozon.ru/project/loms/internal/usecases/orderscanceller.EventSender -o event_sender_mock_test.go -n EventSenderMock -p orderscanceller
