...
//go:generate minimock -i route256.ozon.ru/project/loms/internal/usecases/orderscanceller.txManager -o tx_manager_mock_test.go -n TxManagerMock -p orderscanceller
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Expect(ctx context.Context, f1 func(ctx context.Context, orders OrderRepo, stocks StockRepo) error) *mTxManagerMockWithinTransaction {
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Inspect(f func(ctx context.Context, f1 func(ctx context.Context, orders OrderRepo, stocks StockRepo) error)) *mTxManagerMockWithinTransaction {
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Set(f func(ctx context.Context, f1 func(ctx context.Context, orders OrderRepo, stocks StockRepo) error) (err error)) *TxManagerMock {
	if mmWithinTransaction.defaultExpectation != nil {
...
// Then helper
func (mmWithinTransaction *mTxManagerMockWithinTransaction) When(ctx context.Context, f1 func(ctx context.Context, orders OrderRepo, stocks StockRepo) error) *TxManagerMockWithinTransactionExpectation {
	if mmWithinTransaction.mock.funcWithinTransaction != nil {
		mmWithinTransaction.mock.t.Fatalf("TxManagerMock.WithinTransaction mock is already set by Set")
	}
...
func (mmWithinTransaction *TxManagerMock) WithinTransaction(ctx context.Context, f1 func(ctx context.Context, orders OrderRepo, stocks StockRepo) error) (err error) {
