...
type TxManagerMock struct {
	...
	funcWithinTransaction          func(ctx context.Context, f1 func(ctx context.Context, stocks StockRepo) bool) (err error)
	inspectFuncWithinTransaction   func(ctx context.Context, f1 func(ctx context.Context, stocks StockRepo) bool)
...
type TxManagerMockWithinTransactionParams struct {
	ctx context.Context
	f1  func(ctx context.Context, stocks StockRepo) bool
}
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Expect(ctx context.Context, f1 func(ctx context.Context, stocks StockRepo) bool) *mTxManagerMockWithinTransaction {
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Inspect(f func(ctx context.Context, f1 func(ctx context.Context, stocks StockRepo) bool)) *mTxManagerMockWithinTransaction {
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Set(f func(ctx context.Context, f1 func(ctx context.Context, stocks StockRepo) bool) (err error)) *TxManagerMock {
	if mmWithinTransaction.defaultExpectation != nil {
...
// Then helper
func (mmWithinTransaction *mTxManagerMockWithinTransaction) When(ctx context.Context, f1 func(ctx context.Context, stocks StockRepo) bool) *TxManagerMockWithinTransactionExpectation {
	if mmWithinTransaction.mock.funcWithinTransaction != nil {
		mmWithinTransaction.mock.t.Fatalf("TxManagerMock.WithinTransaction mock is already set by Set")
	}
...
func (mmWithinTransaction *TxManagerMock) WithinTransaction(ctx context.Context, f1 func(ctx context.Context, stocks StockRepo) bool) (err error) {
