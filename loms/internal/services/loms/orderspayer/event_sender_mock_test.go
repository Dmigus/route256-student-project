...
//go:generate minimock -i route256.ozon.ru/project/loms/internal/usecases/orderspayer.EventSender -o event_sender_mock_test.go -n EventSenderMock -p orderspayer
