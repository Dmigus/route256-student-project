...
func TestAddCheckDeleteCheck(t *testing.T) {
	...
	skuId := 773297411
	var urlPath string
	urlPath, _ = url.JoinPath(host, "user", strconv.Itoa(userId), "cart", strconv.Itoa(skuId))
	body, _ := json.Marshal(
		struct {
